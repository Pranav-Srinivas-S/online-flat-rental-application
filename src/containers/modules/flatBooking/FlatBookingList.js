...
const FlatBookingList = () => {
    ...
    const flatBookings = useSelector((state) => state.getAllFlatBookings.flatBookings);
                  ...
                  flatBookings.map((flatBooking) => {
                    ...
                    return (
                      <StyledTableRow key={bookingNo}>
                        ...
                        <td><Link to={`/update-flatBooking`}><Button color="primary" variant="contained" className="btn btn-info">Update</Button></Link></td>
